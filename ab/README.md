...
[A/B тест с ratio метрикой](https://github.com/davyandr/pet-projects/blob/main/ab/ab_ratio.ipynb)| С помощью t-теста и дельта метода проанализировал результаты a/b теста для CTR 
